...
const SailorNecklace = () => {
    ...
    const handleSailorClick = (sailorNumber) => {
        if (sailorNumber === 4) {
          setMessage(<span className="correct">Correct!</span>);
        } else {
          setMessage(<span className="incorrect">Incorrect!</span>);
        }
    }
  ...
  <div className="Styles.container">
    <div className="gameHeader">
      ...
      <p className="gameDescription">
        ...
        Instructions:<br/>
        1. Use only blue striped beads and solid red beads.<br/><br/>
    ...
    <div className="gameHeader">
      <p className="gameDescription">
        <br/><br/>
        These two actions can be done many times in any order to build longer and longer necklaces.<br/><br/>
        <br/><br/>
        Question:<br/><br/>
        Which necklace below is NOT a sailor necklace?<br/><br/>
      </p>
    </div>
